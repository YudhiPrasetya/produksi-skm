...
?>
        ...
        for($a=$JumlahKolomSizeMinNew; $a<=$JumlahKolomSizeMaxNew; $a++){
         ...
         ?>
         <!-- <div> -->
           <table style="float: left; font-size: 12px" border='1' width='16.5%' cellpadding=3 cellspacing=0 >
                <tr>
                    <th width="4%">SIZE</th>
                ...
                <tr>
                    <th width="15px">NO</th>
                    <th width="10px">OUT</th>
                    <th width="10px">BAL</th>
                    <th width="10px">L-DATE</th>
                </tr>
            <?php
                    ...
                    $bundle_data = tampilkan_bundle_orc_nomer_new_transaksi($id_order_detail, $offsetbundle, $limit_baris, $table, $tgl);
                    while($pilih3 = mysqli_fetch_array($bundle_data)){
    
                ?>
               
            <tr height="23px">
                <td <?php if($pilih3['output_total'] == $pilih3['qty_isi_bundle']) { ?> style="background: #7FFFD4" <?php }elseif(($pilih3['output_total'] > 0) && ($pilih3['output_total'] < $pilih3['qty_isi_bundle'])){ ?> style="background: #FFB6C1" <?php } ?> ><center><a href="print_ticket_pecah_bundle.php?id=<?= $id_order ?>&barcode=<?= $pilih3['barcode_bundle']; ?>&proses=<?= $proses ?>&balance=<?= $pilih3['balance']; ?>" target="_blank"> <?= $pilih3['no_bundle']; ?> </a></center></td>
                ...
                <?php
                     $total_output += $pilih3['output_total']; 
                     $total_balance += $pilih3['balance'];
                ?>
            </tr> 
            <?php }  ?>
            ...
            <tr>
                ...
                <td style="background: yellow"><center><b><?= $total_balance ?></b></center></td>
