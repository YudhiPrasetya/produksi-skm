        ...
        for($a=$JumlahKolomSizeMinNew; $a<=$JumlahKolomSizeMaxNew; $a++){
         ...
         <!-- <div> -->
           <table style="float: left; font-size: 12px" border='1' width='16.5%' cellpadding=3 cellspacing=0 >
            ...
            <tr height="23px">
                <td <?php if($pilih3['output_total'] == $pilih3['qty_isi_bundle']) { ?> style="background: #7FFFD4" <?php }elseif(($pilih3['output_total'] > 0) && ($pilih3['output_total'] < $pilih3['qty_isi_bundle'])){ ?> style="background: #FFB6C1" <?php } ?> ><center>
