...
<h3 align="left">Cetak Laporan Packing Summary</h3>
</center>
<br><br>
<table width="70%">
  <tr>
...
<hr width="70%"></hr>
<br>
<b><h3 align="left">Cetak Laporan Packing Summary Rentan Tanggal</h3></b>
</center>
<br>
<table width="70%">
  <tr>
...
<hr width="70%"></hr>
<br>
<h3 align="left">Cetak Per Nomer Purchasing Order Rentan Tanggal</h3>
</center>
<br>
<form action="laporan_packing_po_tanggal.php" method="POST">
<table width="70%">
  <tr>
  <td style="margin:10; padding-right: 20px;" >
        <font color="blue"><b>Tanggal Awal</font><br></b>
      <input type="date" name="tgl_awal" id="tgl_awal" class="form-control pilcek2" required>
    </td>
  <td style="margin:10; padding-right: 20px;">
  <font color="blue"><b>Tanggal Akhir</font><br></b>
      <input type="date" name="tgl_akhir" id="tgl_akhir" class="form-control pilcek2" required>
   </td>
    <td style="margin:10; padding-right: 20px;" >
      <font color="blue"><b>Nomer Purchasing Order</font><br></b>
      <select class="form-control pilcek2" name="no_po" required>
       <option value="">--- Pilih No Purchasing Order ---</option>
       <?php
       $po2= tampilkan_po();
       while($pilih2 = mysqli_fetch_assoc($po2)) {
       echo '<option value='.$pilih2['id_po'].'>'.$pilih2['no_po'].'</option>';
