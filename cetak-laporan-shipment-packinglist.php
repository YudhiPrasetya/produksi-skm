...
<table width="70%">
  <tr>
    <form action="laporan_shipment_packinglist_invoice.php" method="POST">
    <td colspan=2>
  ...
  <tr>
    <form action="laporan_shipment_packinglist_invoice_mixstyle.php" method="POST">
    <td colspan=2>
      <br>
...
<br><br>
<hr width="70%"></hr>
<h3 align="left">Cetak Packinglist Per NO Invoice dan Style</h3>
</center>

<br>

<!-- =========================================================================================== -->
<form action="laporan_shipment_packinglist_po_invoice.php" method="POST">
<table width="70%">
  <tr>
