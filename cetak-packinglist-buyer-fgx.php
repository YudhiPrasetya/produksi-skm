...
<table width="70%">
  <tr>
    <form action="laporan-packinglist-buyer-all-fgx.php" method="POST">
    <td colspan=2>
      ...
      <select class="form-control pilcek3"  name="invoice" required>
        <option value="">------------------------------------------- Pilih No Invoice / Packinglist -------------------------------------------</option>
          <?php
            $invoice= tampilkan_no_invoice_fgx();
  ...
  <tr>
    <form action="laporan-packinglist-buyer-mix-fgx.php" method="POST">
    <td colspan=2>
      <br>
  ...
  <tr>
    <form action="laporan-packinglist-buyer-all-label-fgx.php" method="POST">
    <td colspan=2>
