...
<table width="70%">
  <tr>
    <td style="margin:10">
      <form action="laporan-hasil-kenzin-periode-tanggal.php" method="POST">
...
<table width="100%">
  <tr>
    <td widht="20%">
    <form action="laporan-hasil-kenzin-periode-tanggal-costomer.php" target=”_blank”  method="POST">
        <font color="blue"><b>Tanggal Awal</font><br></b>
      <input type="date" name="tgl_awal" id="tgl_awal" class="form-control pilcek" required>
    </td>
  <td>
