...
<script type="text/javascript">
  $('.ganti').on('change',function(){
    ...
    var line = $('#line').val();
    var color = $('#color').val();
    var url = "tampil_laporan_hasil_scan_global.php?trx="+proses+"&tgl="+tgl+"&orc="+orc+"&style="+style+"&status="+status+"&costomer="+costomer+"&no_po="+no_po+"&category="+category+"&line="+line+"&color="+color;
