...
<h3 align="left">CETAK LAPORAN STOK PACKING BACODE BUYER</h3>
</center><br>
...
<script type="text/javascript">
  $('.ganti').on('change',function(){
    ...
    var url = "tampil_laporan_stok_packing_barcode_buyer.php?tgl="+tgl+"&orc="+orc+"&style="+style+"&costomer="+costomer+"&no_po="+po;
    console.log(url);
