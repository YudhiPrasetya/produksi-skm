...
if($_POST['rowedit']) {
        ...
        $sql = tampilkan_master_qty_karton_id($edit); // memilih entri nim pada database
	...
	?>
         ...
         <div class="form-group">
          <label for="category">QTY FULL CARTON</label>
          <div class="input-group">
            <div class="input-group-addon">
            <i class="glyphicon glyphicon-th-list"></i>
          </div>
          <input type="number" class="form-control" placeholder="Masukkan Qty Karton" name="qty_karton" id="qty_karton" value="<?= $data['qty_karton'] ?>" required>
        </div>
          </div>
