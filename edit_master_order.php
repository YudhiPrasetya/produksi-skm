     ...
     <?php 
         ...
         <td width="180px">
          ...
          <label class="form-check-label" style="font-weight: normal" for="inlineCheckbox<?= $i; ?>"><?= strtoupper(
            ($data2['nama_transaksi'] == "washing" ? "f qc" : ($data2['nama_transaksi'] == "qc_buyer" ? "furushima" :($data2['nama_transaksi'] == "press" ? "press" : ($data2['nama_transaksi'] == "bemis" ? "bemis" :
      ...
      <tr>
          ...
          <input class="form-check-input" type="checkbox" name="proses[]" id="inlineCheckbox<?= $i; ?>" value="<?= $data2['nama_transaksi'] ?>" 
              ...
              ?>>
          <label class="form-check-label" style="font-weight: normal" for="inlineCheckbox<?= $i; ?>"><?= strtoupper(
            ($data2['nama_transaksi'] == "press" ? "press" : $data2['nama_transaksi'])
          ) ?></label>
        </td>
        <?php } } ?>
      </tr>
