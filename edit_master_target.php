...
<div class="form-group">
  ...
  <div class="row">
    <div class="col-md-8">
        <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <select id="line2" class="form-control" name="line" style="width: 100%" required >
                    <?php
    ...
    <div class="col-md-4">
        <div class="form-group">
                <label for="persentase">% TARGET</label>
                <div class="input-group">
                    <div class="input-group-addon"> 
                    <i class="glyphicon glyphicon-list-alt" ></i>
                    </div>
                    <input type="number" class="form-control" value="<?= $data['persentase_target'] ?>"  id="persentase">
                </div>
        </div>
    </div>
...
<div class="col-md-6">
        <div class="form-group">
                <label for="man_power">MAN POWER NORMAL</label>
                <div class="input-group">
                    <div class="input-group-addon"> 
                    <i class="glyphicon glyphicon-list-alt" ></i>
                </div>
                    <input type="number" class="form-control" value="<?= $data['man_power'] ?>"  id="man_power">
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
                <label for="jml_jam_normal">JML JAM NORMAL</label>
                <div class="input-group">
                    <div class="input-group-addon"> 
                    <i class="glyphicon glyphicon-list-alt" ></i>
                </div>
                    <input type="number" class="form-control" value="<?= $data['jml_jam_normal'] ?>"  id="jml_jam_normal">
            </div>
        </div>
    </div>
...
<div class="col-md-6">
        <div class="form-group">
                <label for="man_power_lembur">MAN POWER LEMBUR</label>
                <div class="input-group">
                    <div class="input-group-addon"> 
                    <i class="glyphicon glyphicon-list-alt" ></i>
                </div>
                    <input type="number" class="form-control" value="<?= $data['man_power_lembur'] ?>"  id="man_power_lembur">
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6">  
        <div class="form-group">
            <label for="jml_lembur">JML JAM LEMBUR</label>
            <div class="input-group">
                <div class="input-group-addon"> 
                <i class="glyphicon glyphicon-list-alt" ></i>
                </div>
                <input type="number" class="form-control" value="<?= $data['jml_lembur'] ?>"  id="jml_lembur">
            </div>
        </div>
    </div>
