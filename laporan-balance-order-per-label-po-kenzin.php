...
$qty_total_bal = 0;
$ctk =array();
  $laporan = tampilkan_balance_order_labelkenzin($po);
...
<thead>
	<tr>
        ...
        <th style="background-color:#f4f4f4; "><center>Di Kenzin</center></th>
...
<tr>
         ...
         <td style='background-color:#f4f4f4;' align='center'><?= $qty_total_k ?></td>
