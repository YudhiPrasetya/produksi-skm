...
<h3>LAPORAN HASIL SCAN QC KENSA</h3>
...
$qty_total_semua = 0;
  $ctk =array(); 
  $laporan = tampilkan_hasil_qc_kensa_periode_hari($tglawal, $tglakhir);
...
<table  border='1' class='table table-hover' width=100% cellpadding=6 >
  <thead>
    <tr>
      ...
      <th style="background-color:#f4f4f4; "><center>QC KENSA</center></th>
    </tr>
  </thead>
  <tbody>
    <?php
...
<tr>
  <td width="20%" align="center"></td>
  <td width="60%"></td>
  <td width="20%" align="center">QC KENSA</td>
</tr>
</table>
</body>
