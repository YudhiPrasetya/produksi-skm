...
<h3>LAPORAN HASIL SCAN TATAMI IN</h3>
...
$qty_total_semua = 0;
  $ctk =array(); 
  $laporan = tampilkan_hasil_tatami_in_periode_hari($tglawal, $tglakhir);
    while($pilih = mysqli_fetch_array($laporan)){
      $ctk[$pilih['costomer']][$pilih['tanggal']][]=array(
        'orc'=>$pilih['orc'],
        'no_po'=>$pilih['no_po'],
        'size'=>$pilih['size'],
        'warna'=>$pilih['color'],
...
<table  border='1' class='table table-hover' width=100% cellpadding=6 >
  <thead>
    <tr>
      ...
      <th style="background-color:#f4f4f4; "><center>TATAMI IN</center></th>
    </tr>
  </thead>
  <tbody>
    <?php
