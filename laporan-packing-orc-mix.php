...
<?php
  ...
  $no_karton3=0;
  $ctk =array();
  $laporan = tampilkan_laporan_packing_orc_mix();
    while($pilih = mysqli_fetch_array($laporan)){
      $ctk[$pilih['no_karton']][$pilih['kelompok_size']][]=array(
    ...
    foreach($ctk as $no_karton=>$kelompok)
    foreach($kelompok as $kelompoksize=>$data){
 ?>
 
<table class='hlap' width='100%' >
  <tr>
    <td width='10%'>ORC</td><td width='1%'>: </td><td width='20%' align='left'></td>
    <td width='55%'></td>
    <td width='5%'>No PO</td><td width='1%'>:</td><td width='20%' align='left'></td>
  </tr>
  <tr>
    <td width='10%'>Style</td><td width='1%'>: </td><td width='20%' align='left'>MIX</td>
    <td width='55%'></td>
    <td width='5%'>Label</td><td width='1%'>:</td><td width='20%' align='left'></td>
  </tr>
  <tr>
    <td width='10%'><b>Detail Transaksi</b></td><td width='1%'>:</td><td width='6%'></td>
    <td width='55%'></td>   
    <td width='5%'></td><td width='1%'></td><td width='30%' align='left'></td>   
  </tr>
</table> 
<?php
  $laporan2 = tampilkan_laporan_packing_orc_mix_hidesize();
