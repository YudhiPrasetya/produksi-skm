...
<title>LAPORAN TATAMI REJECT</title>
<center>
<h1>PT. Globalindo Intimates</h1>
<h3>LAPORAN HASIL SCAN REJECT TATAMI</h3>
...
$qty_total_semua = 0;
  $ctk =array(); 
  $laporan = tampilkan_hasil_tatami_reject_periode_hari($tglawal, $tglakhir);
...
<table width = 100%>
  <tr style="font-weight:bold">
    ...
    <td width=70%></td>
    <td width=5%>TANGGAL</td> <td>:</td> <td width=8%><?= $tanggal ?></td></strong>
  </tr>
</table>
...
<table  border='1' class='table table-hover' width=100% cellpadding=6 >
  <thead>
    <tr>
      ...
      <th style="background-color:#f4f4f4; "><center>TATAMI</center></th>
    </tr>
  </thead>
  <tbody>
    <?php
    ...
    <tr>
      ...
      <td align='center'><?php echo strtoupper($pilih['keterangan']); ?></td>
...
<b>Total Scan Reject : <?= $qty_total_semua ?> PCS </b>
</div>
<br>
<table width="100%">
<tr>
...
<tr>
  <td width="20%" align="center"></td>
  <td width="60%"></td>
  <td width="20%" align="center">TATAMI</td>
</tr>
</table>
</body>
