...
?>
    ...
    <h3>LAPORAN SCAN BARCODE</h3>
    
</center>
<?php
$qty_master_order = 0;
$qty_total_qc_kensa = 0;
$qty_total_balance_qc_kensa = 0;
$qty_total_tatami_in = 0;
$qty_total_tatami_out = 0;
$qty_total_outstanding = 0;
$qty_balance_order = 0;
$ctk =array();
  $laporan = tampilkan_balance_order_orc($orc);
  while($pilih = mysqli_fetch_array($laporan)){
    $ctk[$pilih['orc']][$pilih['no_po']][$pilih['label']][$pilih['style']][$pilih['color']][]=array(
      ...
      'qty_qc_kensa'=>$pilih['qty_qc_kensa'],
      'bal_qc_kensa'=>$pilih['bal_qc_kensa'],
...
<thead>
	<tr>
        ...
        <th style="background-color:#f4f4f4; " rowspan="1" ><center>SEWING</center></th>
        <th style="background-color:#f4f4f4; " colspan="3"><center>QC KENSA</center></th>
        <th style="background-color:#f4f4f4; " colspan="3"><center>TATAMI</center></th>
        <th style="background-color:#f4f4f4; " rowspan="1" ><center>PACKING</center></th>
  	</tr>
    <tr>
        ...
        <th style="background-color:#f4f4f4; "><center>OUT</center></th>
        <th style="background-color:#f4f4f4; "><center>WIP</center></th>
        <th style="background-color:#f4f4f4; "><center>STOCK</center></th>
    </tr>
</thead>
<tbody>
  <?php
  ...
  ?>
    ...
    <td align='center'>
      <?php echo $pilih['qty_qc_kensa']; ?>
    </td>
    <td align='center'>
      <?php echo $pilih['qty_tatami_in']; ?>
    </td>
    <td align='center'>
      <?php echo $pilih['bal_qc_kensa']; ?>
    </td>
    <td align='center'>
      <?php echo $pilih['qty_tatami_in']; ?>
    </td>
 ...
 $qty_total_qc_kensa += $pilih['qty_qc_kensa'];
 $qty_total_balance_qc_kensa += $pilih['bal_qc_kensa'];
...
<tr>
         ...
         <td style='background-color:#f4f4f4;' align='center'><?= $qty_total_qc_kensa ?></td>
         <td style='background-color:#f4f4f4;' align='center'><?= $qty_total_tatami_in ?></td>
         <td style='background-color:#f4f4f4;' align='center'><?= $qty_total_balance_qc_kensa ?></td>
         <td style='background-color:#f4f4f4;' align='center'><?= $qty_total_tatami_in ?></td>
