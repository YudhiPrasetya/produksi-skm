...
$qty_total_semua = 0;
  $ctk =array(); 
  $laporan = tampilkan_laporan_daily_production_scan($tgl, $table, $orc, $style, $costomer, $no_po, $category);
    while($pilih = mysqli_fetch_array($laporan)){
      $ctk[$pilih['costomer']][]=array(
        'orc'=>$pilih['orc'],
        'no_po'=>$pilih['no_po'],
        'item'=>$pilih['item'],
        'size'=>$pilih['size'],
    ...
    foreach($ctk as $costomer=>$data){
 ?>
</center>
COSTOMER : <?= $costomer ?> </div>
<center>
<table  border='1' class='table table-hover' width=100% cellpadding=6 >
  <thead>
    <tr>
      ...
      <th style="background-color:#f4f4f4;" rowspan=2><center>ITEM</center></th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align='center'><?php echo $pilih['item'] ?></td>
