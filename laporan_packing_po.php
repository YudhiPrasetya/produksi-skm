...
<?php
  ...
  $laporan = tampilkan_laporan_packing_po($po);
    while($pilih = mysqli_fetch_array($laporan)){
      $ctk[$pilih['no_po']][$pilih['style']][$pilih['warna']][$pilih['kelompok_size']][]=array(
    ...
    foreach($ctk as $no_po=>$kode_style)
...
<?php
  $laporan2 = tampilkan_laporan_packing_po_hidesize($po);
...
?>
  TOTAL SCAN : PO : <?= $no_po ?> Semuanya : <br>
