...
<?php
  $po=$_POST['no_po'];
  $laporan = tampilkan_laporan_packing_po($po);
...
<h4><font color="blue">Nomer Purchasing Order : <?= $data['no_po']; ?></font><br><br>
<?= tanggal_indo2($tgl_awal, true); ?> s/d <?= tanggal_indo2($tgl_akhir, true); ?>
</h4>
</center>
...
<?php
  ...
  $no_karton3=0;
  $ctk =array();
  $laporan = tampilkan_laporan_packing_po_tanggal($po, $tgl_awal, $tgl_akhir);
