...
?>
 ...
 <div class="row justify-content-center">
    <button class="btn btn-success" id="btnExportToExcel"> Export To Excel</button>
</div>
...
<table  border='1' class='table table-striped table-hover' width=100% cellpadding="2px"; cellspacing="0" style="font-size: 13px;">
  ...
  <tbody>
    <?php
          $no=1;       
        $laporan2 = tampilkan_laporan_packinglist_orc3($id_shipment, $orc, $var_sumsize);
    ...
    <tr>
        ...
        <tr>
            <td colspan="<?php $total_size = cek_jumlah_size_orc_invoice2($id_shipment, $orc) + 8; echo $total_size;  ?>">
...
<table  border='1' class='table table-striped table-hover' width=100% cellpadding="2px"; cellspacing="0" style="font-size: 13px;">
  ...
  <tbody>
    <?php
          $no=1;       
        $laporan4 = tampilkan_laporan_packinglist_invoice_mixstyle2($id_shipment, $no_trx2, $var_sumsize);
    ...
    <tr>
        ...
        <tr>
            <td colspan="<?php $total_size = cek_jumlah_size_notrx_invoice_mixstyle2($id_shipment, $no_trx2) + 8; echo $total_size;  ?>">
                TOTAL QUANTITY : <?= $qty_total ?> PCS
            </td>
        </tr>
        <tr>
...
<script type="text/javascript">
    $('#btnExportToExcel').click(function(e) {
      ...
      let file = new Blob([$('#tablesContainer').html()], {
