...
?>
    ...
    <h3>PACKING LIST</h3>
    <h4><?= tanggal_indo($tgl_awal, false); ?> s/d <?= tanggal_indo($tgl_akhir, false); ?></center>
...
<tbody>
    ...
    $laporan1 = tampilkan_laporan_packinglist_tanggal($po, $style, $tgl_awal, $tgl_akhir);
  ...
  <?php
    ...
    $laporan_mix = tampilkan_laporan_packinglist_tanggal_mix($po, $style, $tgl_awal, $tgl_akhir);
