...
?>
    ...
    <h3>LAPORAN SCAN PACKING YANG SUDAH DI SHIPMENT</h3>
    <h4><?= $data4['no_invoice']; ?>
    <br>
    <?= tanggal_indo($tgl_awal, false); ?> s/d <?= tanggal_indo($tgl_akhir, false); ?></h4>
    </center>
...
$no_karton2=0; 
$ctk =array(); 
  $laporan = tampilkan_laporan_shipment_tanggal_periode($tgl_awal, $tgl_akhir, $invoice);
  while($pilih = mysqli_fetch_array($laporan)){
    $ctk[$pilih['tanggal_scan']][$pilih['no_karton']][$pilih['kelompok']][]=array(
      'no_po'=>$pilih['no_po'],
      'label'=>$pilih['label'],
...
?>
<tr>
  <td align='center'><?= $pilih['jam_scan'] ?></td>
