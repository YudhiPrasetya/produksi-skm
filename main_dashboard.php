                           ...
                           <div class="card-header p-2 ps-3 bg-gradient-dark">
                              <div class="d-flex justify-content-between">
                                 <div>
                                    ...
                                    <h4 class="mb-0 text-white">12/03/2025</h4>
                                 </div>
                        ...
                        <div class="card shadow">
                           ...
                           <div class="d-flex justify-content-between">
                              <div>
                                 ...
                                 <h4 class="mb-0 text-white">10B</h4>
                              </div>
                              <div class="icon icon-md icon-shape bg-gradient-success shadow-dark shadow text-center border-radius-lg">
                           ...
                           <hr class="dark horizontal my-0">
                           <div class="card-footer p-2 ps-3">
                           <p class="mb-0 text-sm"><span class="text-success font-weight-bolder">SPV </span>IKA</p>
                           </div>
                        </div>
                     </div>
                              ...
                              <div class="card-body px-0 pb-2">
                                 <!-- <div class="table-responsive p-0"> -->
                                    <table class="table align-items-center mb-0">
                                       <thead>
                                          <tr>
                                             <th class="text-uppercase text-secondary font-weight-bolder align-middle text-center">No.</th>
                                             ...
                                             <th class="text-uppercase text-secondary font-weight-bolder align-middle text-center">Output</th>
                                       ...
                                       <tbody>
                                          <tr>
                                             ...
                                             <td class="align-middle text-center">G3-25B105B-1</td>
                                             <td class="align-middle text-center">2001264 (72335)</td>
                                             <td class="align-middle text-center">5.396</td>
                                             <td class="align-middle text-center">
                                                <span class="badge badge-sm bg-gradient-success">2.033</span>
                                             </td>
                                             <td class="align-middle text-center">
                                                <span class="badge badge-sm bg-gradient-warning">3.363</span>
                                             </td>
                                          </tr>   
                                       </tbody>                        
                                    </table>
                     ...
                     <div class="col-md-6 col-sm-6 mb-xl-0 mb-2">
                        <div class="card shadow">
                           <div class="card-header p-2 ps-3 bg-gradient-dark">
                              <div class="d-flex justify-content-between">
                                 <div>
                                    <p class="text-sm mb-0 text-capitalize text-white">Today Line Performance</p>
                                    <h4 class="mb-0 text-white">85.00%</h4>
                                 </div>
                                 <div class="icon icon-md icon-shape bg-gradient-success shadow-dark shadow text-center border-radius-lg">
                           ...
                           <div class="card-header p-2 ps-3 bg-gradient-dark">
                              <div class="d-flex justify-content-between">
                                 <div>
                                    ...
                                    <h4 class="mb-0 text-white">00:32:00</h4>
                                 </div>
                                 <div class="icon icon-md icon-shape bg-gradient-success shadow-dark shadow text-center border-radius-lg">
                           ...
                           <div class="card-header p-2 ps-3 bg-gradient-dark">
                              <div class="d-flex justify-content-between">
                                 <div>
                                    ...
                                    <h4 class="mb-0 text-white">150</h4>
                                 </div>
                                 <div class="icon icon-md icon-shape bg-gradient-success shadow-dark shadow text-center border-radius-lg">
                                    <i class="material-symbols-rounded opacity-10">manufacturing</i>
                                 </div>
                           ...
                           <div class="card-header p-2 ps-3 bg-gradient-dark">
                              <div class="d-flex justify-content-between">
                                 <div>
                                    ...
                                    <h4 class="mb-0 text-white">1.883</h4>
                                 </div>
                           ...
                           <div class="card-header p-2 ps-3 bg-gradient-dark">
                              <div class="d-flex justify-content-between">
                                 <div>
                                    ...
                                    <h4 class="mb-0 text-white">1.000</h4>
                                 </div>
                                 <div class="icon icon-md icon-shape bg-gradient-success shadow-dark shadow text-center border-radius-lg">
                           ...
                           <div class="card-header p-2 ps-3 bg-gradient-dark">
                              <div class="d-flex justify-content-between">
                                 <div>
                                    ...
                                    <h4 class="mb-0 text-white">1.033</h4>
                                 </div>
                                 <div class="icon icon-md icon-shape bg-gradient-info shadow-dark shadow text-center border-radius-lg">
                                    <i class="material-symbols-rounded opacity-10">inventory_2</i>
                                 </div>
