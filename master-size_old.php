...
<table border="1px" class="table table-striped table-bordered data">
  <thead>
    <tr>
      ...
      <th class="tengah theader">Kelompok</th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="tengah">
        <button type="button" id="edit" data-toggle="modal" data-target="#myEdit" class="btn btn-success edit_komentar kecil" data-id="<?= $row['id_size']; ?>"><i class="glyphicon glyphicon-edit"></i></button>
        <a href="hapus_size_satu.php?id=<?= $row['id_size']; ?>"><button type="button" class="btn btn-xs btn-danger kecil"><i class="glyphicon glyphicon-trash"></i></button></a>
      </td>
    </tr>
    <?php
      $no++;
  ...
  <!-- konten modal-->
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title"><font face="Calibri" color="red"><b>Edit Data Master Size</b></font></h4>
      </div>
      <!-- body modal -->
