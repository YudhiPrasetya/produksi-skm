         ...
         <!-- <div> -->
           <table style="float: left; font-size: 12px" border='1' width='16.5%' cellpadding=3 cellspacing=0 >
            ...
            <?php
                    ...
                    $bundle_data = tampilkan_bundle_orc_nomer_new($id_order_detail, $offsetbundle, $limit_baris);
            ...
            <?php } } ?>
            <tr>
                <td colspan="6" style="background: yellow"><center><b><?= $jumlah_bundle_size ?> BOX</b></center></td>
            </tr>
        </table>
        <?php 
        $hasil = $a%6;
