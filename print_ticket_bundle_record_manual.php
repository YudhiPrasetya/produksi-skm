...
?>
   ...
   <div style="width: 200mm; height 320mm; margin-bottom: <?php echo 92+$p ?>px;" >
        ...
        $jumlahTiketPerhal = cek_jumlah_ticket_bundle_hal_id_array($id, $offsetLembar, $limitTicket);
        $sql = tampilkan_ticket_bundle_id_array($id, $offsetLembar, $limitTicket); // memilih entri nim pada database
