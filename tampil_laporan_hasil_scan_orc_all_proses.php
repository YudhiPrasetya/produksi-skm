...
<div style="margin: 20px">
  ...
  <thead>
      ...
      <th  style="text-align: center; background: #1E90FF" rowspan=2>SIZE</th>
...
$total_output = 0;
$total_balance = 0;
$sql = tampilkan_laporan_bundle_record_detail_size($table, $tgl, $orc, $style, $status, $costomer, $category, $plan_line, $jalan_line);
...
$no++;
 ...
 <tfoot>
    <tr>
        <td colspan="8" style="background: #1E90FF; color: white"><b>TOTAL:</b></td>
