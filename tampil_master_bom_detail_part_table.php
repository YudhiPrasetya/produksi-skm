...
<tbody>
  <?php 
  $part = tampilkan_master_part_table_bom($id, $search1);
       ...
       $.ajax({
        ...
        success: function(data){
            ...
            if(data.trim() == "success"){
              url8 = "tampil_master_bom_detail_part_table.php?id="+id+"&id_style="+id_style+"&search1="+search1+"&search2="+search2;
                $('#search_part_table1').load(url8);
              url9 = "tampil_master_bom_detail_part_table2.php?id="+id+"&id_style="+id_style+"&search1="+search1+"&search2="+search2;
