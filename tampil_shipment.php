...
<div style="margin-left: 15px; margin-right:15px">
  ...
  <?php 
  $laporan2 = tampilkan_laporan_packing_hidesize($costomer, $po, $orc, $style);
  $pilih3 = mysqli_fetch_array($laporan2);
?>
<center>
    <input type="hidden" id="user" value="<?= $user ?>">
    <input type="hidden" id="packinglist" value="<?= $pl ?>">
    <input type="hidden" id="po" value="<?= $po ?>">
    <input type="hidden" id="orc" value="<?= $orc ?>">
    <input type="hidden" id="style" value="<?= $style ?>">
    <input type="hidden" id="costomer" value="<?= $costomer ?>">
  <table border="1px" id="tabel" class="table table-striped table-bordered data">
    <thead>
     ...
     ?>"><center>SIZE</center></th>
      ...
      <tr>
        ...
        <th style="background-color:#20B2AA; color: #ffffff; display: <?php if($pilih3['size_70'] == 0){ echo "none"; } ?>;"><center>70</center></th>
        <th style="background-color:#20B2AA; color: #ffffff; display: <?php if($pilih3['size_73'] == 0){ echo "none"; } ?>;"><center>73</center></th>
        <th style="background-color:#20B2AA; color: #ffffff; display: <?php if($pilih3['size_76'] == 0){ echo "none"; } ?>;"><center>76</center></th>
        <th style="background-color:#20B2AA; color: #ffffff; display: <?php if($pilih3['size_79'] == 0){ echo "none"; } ?>;"><center>79</center></th>
        <th style="background-color:#20B2AA; color: #ffffff; display: <?php if($pilih3['size_82'] == 0){ echo "none"; } ?>;"><center>82</center></th>
        <th style="background-color:#20B2AA; color: #ffffff; display: <?php if($pilih3['size_85'] == 0){ echo "none"; } ?>;"><center>85</center></th>
        <th style="background-color:#20B2AA; color: #ffffff; display: <?php if($pilih3['size_88'] == 0){ echo "none"; } ?>;"><center>88</center></th>
        <th style="background-color:#20B2AA; color: #ffffff; display: <?php if($pilih3['size_91'] == 0){ echo "none"; } ?>;"><center>91</center></th>
        <th style="background-color:#20B2AA; color: #ffffff; display: <?php if($pilih3['size_95'] == 0){ echo "none"; } ?>;"><center>95</center></th>
        <th style="background-color:#20B2AA; color: #ffffff; display: <?php if($pilih3['size_100'] == 0){ echo "none"; } ?>;"><center>100</center></th>
        <th style="background-color:#20B2AA; color: #ffffff; display: <?php if($pilih3['size_105'] == 0){ echo "none"; } ?>;"><center>105</center></th>
        <th style="background-color:#20B2AA; color: #ffffff; display: <?php if($pilih3['size_110'] == 0){ echo "none"; } ?>;"><center>110</center></th>
        <th style="background-color:#20B2AA; color: #ffffff; display: <?php if($pilih3['size_115'] == 0){ echo "none"; } ?>;"><center>115</center></th>
        <th style="background-color:#20B2AA; color: #ffffff; display: <?php if($pilih3['size_120'] == 0){ echo "none"; } ?>;"><center>120</center></th>
        <th style="background-color:#20B2AA; color: #ffffff; display: <?php if($pilih3['size_130'] == 0){ echo "none"; } ?>;"><center>130</center></th>
        <th style="background-color:#20B2AA; color: #ffffff; display: <?php if($pilih3['size_140'] == 0){ echo "none"; } ?>;"><center>140</center></th>
        <th style="background-color:#20B2AA; color: #ffffff; display: <?php if($pilih3['size_150'] == 0){ echo "none"; } ?>;"><center>150</center></th>
        <th style="background-color:#20B2AA; color: #ffffff; display: <?php if( $pilih3['size_86_3'] == 0){ echo "none"; } ?>;"><center>86-3</center></th>
        <th style="background-color:#20B2AA; color: #ffffff; display: <?php if($pilih3['size_90_4'] == 0){ echo "none"; } ?>;"><center>90-4</center></th>
        <th style="background-color:#20B2AA; color: #ffffff; display: <?php if($pilih3['size_94_5'] == 0){ echo "none"; } ?>;"><center>94-5</center></th>
        <th style="background-color:#20B2AA; color: #ffffff; display: <?php if($pilih3['size_98_6'] == 0){ echo "none"; } ?>;"><center>98-6</center></th>
    ...
    <tbody>
      <?php
        $no=1;
        $laporan3 = transaksi_scan_packing($costomer, $po, $orc, $style);
      ...
      <tr class="belang">
        ...
        <td align='center'><a class="btn-klik" href="edit_packing.php?trx=<?= $pilih2['no_trx']; ?>"><?= $pilih2['no_trx']; ?></a></td>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    var packinglist = $('#packinglist').val();
    var url3 = "tampil_temp_shipment.php?pl="+packinglist;
    $('#tampil_tabel2').load(url3);
  });
