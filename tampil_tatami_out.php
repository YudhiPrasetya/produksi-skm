...
Total Qty Scan :
<?php
    $temp_tatami_out_total = tampilkan_temp_tatami_out($user);
    $subtotal_qty=0;
    while($data=mysqli_fetch_assoc($temp_tatami_out_total)){
...
<?php
$temp_tatami_out = tampilkan_temp_tatami_out($_SESSION['username']);
?>
<!-- <div class="container"> -->
...
$no=1;
$subtotal_qty=0;
while($row=mysqli_fetch_assoc($temp_tatami_out))
{ 
...
if (tanya3 == true) return true;
  ...
  <td class="tengah"><a href="hapus_tatami_out_satu.php?id=<?= $row['ids_to_delete']; ?>" onclick="return konfirmasi_kurangi()">DELETE</a></td>
  </tr>
