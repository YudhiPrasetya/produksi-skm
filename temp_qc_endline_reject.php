...
cek_status($_SESSION['username'] ) == 'qc_endline' ) {
...
<center>
<font color="blue">
<h2>TRANSAKSI QC ENDLINE REJECT</h2>
...
<div class="col-sm-2">
 <font color="blue"><b>DATE OUTPUT</font><br></b>
...
<div class="col-sm-3">
 <font color="blue"><b>TYPE REJECT</font><br></b>
   <div class="input-group">
     <div class="input-group-addon">
     <i class="glyphicon glyphicon-edit"></i>
   </div>
   <select id="type_reject" class="form-control" name="type_reject" required >
            <option value="">- ALL TYPE REJECT -</option>
            <option value="spec">SPEC</option>
            <option value="looking for finishgood">LOOKING FOR FINISHGOOD</option>
            <option value="fabric">FABRIC</option>
            <option value="sewing process">SEWING PROCESS</option>
 ...
 <div class="col-sm-4">
 <font color="blue"><b>PILIH REJECT</font><br></b>
   <div class="input-group">
     <div class="input-group-addon">
     <i class="glyphicon glyphicon-edit"></i>
   </div>
   <select id="pilih_reject" class="form-control" name="pilih_reject" required >     
    </select>
 </div>
 </div>
...
$(document).ready(function () {
    $("#pilih_reject").select2({
        theme: 'bootstrap4',
        placeholder: "Please Select"
    });

    var type_reject = $("#type_reject").val();
...
// Menggunakan ajax untuk mengirim dan dan menerima data dari server
    $.ajax({
        ...
        $("#pilih_reject").html(data);
    }
    });
});

$("#type_reject").change(function(){
