...
cek_status($_SESSION['username'] ) == 'ie' ) {
  ...
  $sql = tampil_master_target_id($id); // memilih entri nim pada database
...
<center>
<h2>INPUT TARGET HARIAN ( COPY DATA )</h2>
...
<div class="col-sm-3">
 <font color="blue"><b>Masukkan ORC</font><br></b>
   ...
   <input type="text" class="form-control pilcek" id="orc2" style="width: 180px; display: inline-block" value="<?= $data['orc'] ?>" disabled >
   <input type="hidden" value = <?= $_SESSION['username']; ?> id="user" >
   <input type="hidden" name="id_order" id="id_order" value="<?= $data['id_order'] ?>" required >
...
<div class="col-sm-2">
 <font color="blue"><b>COSTOMER</font><br></b>
   ...
   <input type="text" id="costomer" class="form-control" value="<?= $data['costomer'] ?>"  />
 </div>
</div>
...
<div class="col-sm-2">
 <font color="blue"><b>No PO</font><br></b>
   ...
   <input type="text" id="no_po" class="form-control" value="<?= $data['no_po'] ?>" />
 </div>
</div>
...
<div class="col-sm-2">
    ...
    <div class="input-group">
      ...
      <input type="text" class="form-control" id="style" value="<?= $data['style'] ?>">
    </div>
  </div>
...
<div class="col-sm-2">
 ...
 <font color="blue"><b>NILAI SMV</font><br></b>
  <input type="hidden" name="nilai_smv" id="nilai_smv2" value="<?= $data['nilai_smv'] ?>" required>
   <input type="text" id="nilai_smv" class="form-control" value="<?= $data['nilai_smv'] ?>" disabled />
...
<div class="col-sm-2">
 <font color="blue"><b>MAN POWER</font><br></b>
   ...
   <input type="number" class="form-control" name="man_power" value="<?= $data['man_power'] ?>" id="man_power">
...
<div class="col-sm-2">
 <font color="blue"><b>PERSENTASE TARGET ( % ) </font><br></b>
   ...
   <input type="number" class="form-control" name="persentase" id="persentase" value="<?= $data['persentase_target'] ?>" required>
