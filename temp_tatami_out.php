...
<form action="simpan_master_tatami_out.php" method="post" >
<center>
    ...
    <a href="hapus_tatami_out.php" name="reset"><button type="button" class="btn btn-danger" onclick="return konfirmasi()"> RESET</button></a>
    </div>
    </form>
    ...
    $.ajax({
      ...
      success: function(data){
        ...
        if(data.trim() == "success"){
          $('#tampil_tabel').load("tampil_tatami_out.php");
        }else if(data.trim() == "errorDb"){
          alert("Gagal Ada masalah dengan kode barcode");
        }else if(data.trim() == "errorQtyPrev"){
          alert("Gagal Qty Lebih Dari Qty Transaksi Sebelumnya atau belum di scan di proses sebelumnya");
