    ...
    $.ajax({
      ...
      success: function(data){
        ...
        if(data.trim() == "success"){
          ...
          alert("Qty Moulding Masih 0");
        }else if(data.trim() == "preparation"){
          alert("Qty Preparation Masih 0");
        }else if(data.trim() == "press"){
          alert("Qty Press Masih 0");
        }else if(data.trim() == "moulding1"){
          alert("Qty Moulding Yang Belum Melebihi Hasil Trimstore Sekarang");
        }else if(data.trim() == "preparation1"){
          alert("Qty Preparation Yang Belum Melebihi Hasil Trimstore Sekarang");
        }else if(data.trim() == "press1"){
          alert("Qty Press Yang Belum Melebihi Hasil Trimstore Sekarang");
