...
$laporan4 = tampilkan_master_shipment_id($pl);
    ...
    $user = $_SESSION['username'];
        ...
        $ListSize = tampilkan_size_transaksi_packing_tarikpl2($orc, $id_costomer, $no_po, $style);
...
<table border="1px" id="example" class="table table-striped table-bordered data" style="font-size: 13px">
    <thead>
        ...
        <th style="background-color: #20B2AA; color: #ffffff; vertical-align:middle; color: #ffffff" rowspan="2"><input type="checkbox" id="check-all"></th>
            ...
            <th style="background-color: #20B2AA; color: #ffffff; vertical-align:middle; color: #ffffff" colspan="<?= cek_jumlah_transaksi_shipment_from_packing2($id_costomer, $orc, $style, $no_po); ?>"><center>SIZE</center></th>
        ...
        <tr>
            <?php $ListSize2 = tampilkan_size_transaksi_shipment_from_packing2($id_costomer, $orc, $style, $no_po); 
  ...
  $(document).ready(function() {
    ...
    columns.push({ 'data' : 'kelompok', 'className' : 'warnaKolom' },);
            $('#example').DataTable({
                ...
                "order": [], 
                "ajax":{
                        "url": "transaksi_shipment_all_ss2.php",
                        "dataType": "json",
                        "type": "POST",
                        "data" : {
                            "action" : "table_data",
