...
if($_POST['checkstyle'] == 'iya'){
  $sql .= " WHERE C.no_po LIKE '%$no_po%' AND A.orc LIKE '%$orc%' AND D.style = '$style' AND C.id_costomer = $id_costomer 
...
$where = " WHERE C.no_po LIKE '%$no_po%' AND A.orc LIKE '%$orc%' AND D.style LIKE '%$style%' AND C.id_costomer = $id_costomer 
AND A.shipment = 'n' AND C.status = 'open'
